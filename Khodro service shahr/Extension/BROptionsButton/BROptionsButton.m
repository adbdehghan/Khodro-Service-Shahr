...
- (void)installTheButton
{
    ...
    if(self.tabBar.items.count > self.locationIndexInTabBar) {
        ...
        CGRect myRect = CGRectMake(self.tabBar.superview.center.x, pointToSuperview.y-25, 60, 60);
//        CGRect myRect = CGRectMake(pointToSuperview.x+27, pointToSuperview.y-50, 60, 60);
        self.frame = myRect;
        self.backgroundColor = [UIColor colorWithRed:49.f/255.f green:148.f/255.f blue:16.f/255.f alpha:1];
        ...
        [self performSelector:@selector(transparent) withObject:nil afterDelay:3];
    }
}
