...
//        orbit.keyPath = [NSString stringWithFormat:@"position%d",i];
...
//        
//        [element.layer addAnimation:orbit forKey:[NSString stringWithFormat:@"ani-track%d",i]];
...
-(void) showMenu:(UIView*)container{
...
-(UIColor *) dimBackgroundColor{
    if(!_dimBackgroundColor){
        _dimBackgroundColor = [UIColor colorWithWhite:1 alpha:0.3];
    }
