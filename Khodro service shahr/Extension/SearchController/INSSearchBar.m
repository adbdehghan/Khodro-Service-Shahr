...
//		self.searchFrame.layer.cornerRadius = CGRectGetHeight(self.bounds) / 2;
		...
		self.searchField.font = [UIFont fontWithName:@"B Yekan+" size:16.0];
        ...
        self.searchField.textAlignment = NSTextAlignmentRight;
        [self.searchField setReturnKeyType:UIReturnKeyDone];
        [self.searchField setKeyboardType:UIKeyboardTypeWebSearch];
		...
		self.searchImageViewOn.image = [UIImage imageNamed:@"NavBarIconSearch_white"];
